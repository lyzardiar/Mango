...
ImGuiStyle::ImGuiStyle()
{
    ...
    Colors[ImGuiCol_TitleBg]                = ImVec4(0.97f, 0.27f, 0.54f, 0.83f); //ImVec4(0.27f, 0.27f, 0.54f, 0.83f);
    Colors[ImGuiCol_TitleBgCollapsed]       = ImVec4(0.40f, 0.40f, 0.80f, 0.20f);
    Colors[ImGuiCol_TitleBgActive]          = ImVec4(0.99f, 0.00f, 0.00f, 0.87f);
	...
	ImU32 col_main_text = 0xdbede2;
	ImU32 col_main_head = 0x202088;
	ImU32 col_main_area = 0x333844;
	ImU32 col_win_popup = 0x77c4d3;
	ImU32 col_win_backg = 0x21232b;

	style->Colors[ImGuiCol_Text] = ImGui::ColorConvertU32ToFloat4(col_main_text, 1.00f);
	style->Colors[ImGuiCol_TextDisabled] = ImGui::ColorConvertU32ToFloat4(col_main_text, 0.58f);
	style->Colors[ImGuiCol_WindowBg] = ImGui::ColorConvertU32ToFloat4(col_win_backg, 0.90f);
	style->Colors[ImGuiCol_ChildWindowBg] = ImGui::ColorConvertU32ToFloat4(col_main_area, 0.58f);
	style->Colors[ImGuiCol_Border] = ImGui::ColorConvertU32ToFloat4(col_win_backg, 0.00f);
	style->Colors[ImGuiCol_BorderShadow] = ImGui::ColorConvertU32ToFloat4(col_win_backg, 0.00f);
	style->Colors[ImGuiCol_FrameBg] = ImGui::ColorConvertU32ToFloat4(col_main_area, 1.00f);
	style->Colors[ImGuiCol_FrameBgHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.78f);
	style->Colors[ImGuiCol_FrameBgActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_TitleBg] = ImGui::ColorConvertU32ToFloat4(col_main_area, 1.00f);
	style->Colors[ImGuiCol_TitleBgCollapsed] = ImGui::ColorConvertU32ToFloat4(col_main_area, 0.75f);
	style->Colors[ImGuiCol_TitleBgActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_MenuBarBg] = ImGui::ColorConvertU32ToFloat4(col_main_area, 0.47f);
	style->Colors[ImGuiCol_ScrollbarBg] = ImGui::ColorConvertU32ToFloat4(col_main_area, 1.00f);
	style->Colors[ImGuiCol_ScrollbarGrab] = ImGui::ColorConvertU32ToFloat4(col_win_popup, 0.21f);
	style->Colors[ImGuiCol_ScrollbarGrabHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.78f);
	style->Colors[ImGuiCol_ScrollbarGrabActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_ComboBg] = ImGui::ColorConvertU32ToFloat4(col_main_area, 1.00f);
	style->Colors[ImGuiCol_CheckMark] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.80f);
	style->Colors[ImGuiCol_SliderGrab] = ImGui::ColorConvertU32ToFloat4(col_win_popup, 0.14f);
	style->Colors[ImGuiCol_SliderGrabActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_Button] = ImGui::ColorConvertU32ToFloat4(col_win_popup, 0.14f);
	style->Colors[ImGuiCol_ButtonHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.86f);
	style->Colors[ImGuiCol_ButtonActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_Header] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.76f);
	style->Colors[ImGuiCol_HeaderHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.86f);
	style->Colors[ImGuiCol_HeaderActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_Column] = ImGui::ColorConvertU32ToFloat4(col_win_popup, 0.32f);
	style->Colors[ImGuiCol_ColumnHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.78f);
	style->Colors[ImGuiCol_ColumnActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_ResizeGrip] = ImGui::ColorConvertU32ToFloat4(col_win_popup, 0.04f);
	style->Colors[ImGuiCol_ResizeGripHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.78f);
	style->Colors[ImGuiCol_ResizeGripActive] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_CloseButton] = ImGui::ColorConvertU32ToFloat4(col_main_text, 0.16f);
	style->Colors[ImGuiCol_CloseButtonHovered] = ImGui::ColorConvertU32ToFloat4(col_main_text, 0.39f);
	style->Colors[ImGuiCol_CloseButtonActive] = ImGui::ColorConvertU32ToFloat4(col_main_text, 1.00f);
	style->Colors[ImGuiCol_PlotLines] = ImGui::ColorConvertU32ToFloat4(col_main_text, 0.63f);
	style->Colors[ImGuiCol_PlotLinesHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_PlotHistogram] = ImGui::ColorConvertU32ToFloat4(col_main_text, 0.63f);
	style->Colors[ImGuiCol_PlotHistogramHovered] = ImGui::ColorConvertU32ToFloat4(col_main_head, 1.00f);
	style->Colors[ImGuiCol_TextSelectedBg] = ImGui::ColorConvertU32ToFloat4(col_main_head, 0.43f);
	style->Colors[ImGuiCol_PopupBg] = ImGui::ColorConvertU32ToFloat4(col_win_backg, 0.92f);
	style->Colors[ImGuiCol_ModalWindowDarkening] = ImGui::ColorConvertU32ToFloat4(col_main_area, 0.73f);
}
...
ImVec4 ImGui::ColorConvertU32ToFloat4(ImU32 in, float alpha)
{
	float s = 1.0f / 255.0f;
	return ImVec4(
		((in >> IM_COL32_R_SHIFT) & 0xFF) * s,
